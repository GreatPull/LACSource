...
public class RenderUtil
{
	...
	public static void drawBorderedRect(final float x, final double d, final float x2, final double e, final float l1, final int col1, final int col2) {
	...
	public static void drawRoundedRect(float x, float y, float x1, float y1, int borderC, int insideC) {
		enableGL2D();
		GL11.glScalef((float) 0.5f, (float) 0.5f, (float) 0.5f);
		drawHLine(x *= 2.0f, (y *= 2.0f) + 1.0f, (y1 *= 2.0f) - 2.0f, borderC);
		drawHLine((x1 *= 2.0f) - 1.0f, y + 1.0f, y1 - 2.0f, borderC);
