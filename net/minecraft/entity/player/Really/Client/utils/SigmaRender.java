...
public class SigmaRender {
   public static void drawOutlinedString(String str, float x, float y, int color) {
      Minecraft mc = Minecraft.getMinecraft();
      Minecraft.fontRendererObj.drawStringWithShadow(str, x - 0.3F, y, (new Color(((Double)setColor.r.getValue()).intValue(), ((Double)setColor.g.getValue()).intValue(), ((Double)setColor.b.getValue()).intValue())).getRGB());
      Minecraft.fontRendererObj.drawStringWithShadow(str, x + 0.3F, y, (new Color(((Double)setColor.r.getValue()).intValue(), ((Double)setColor.g.getValue()).intValue(), ((Double)setColor.b.getValue()).intValue())).getRGB());
      Minecraft.fontRendererObj.drawStringWithShadow(str, x, y + 0.3F, (new Color(((Double)setColor.r.getValue()).intValue(), ((Double)setColor.g.getValue()).intValue(), ((Double)setColor.b.getValue()).intValue())).getRGB());
      Minecraft.fontRendererObj.drawStringWithShadow(str, x, y - 0.3F, (new Color(((Double)setColor.r.getValue()).intValue(), ((Double)setColor.g.getValue()).intValue(), ((Double)setColor.b.getValue()).intValue())).getRGB());
      Minecraft.fontRendererObj.drawStringWithShadow(str, x, y, color);
   }
   ...
   public static void drawCenteredGradient(double x, double y, double x2, double y2, int col1, int col2) {
      ...
      for(double i = Math.min(x, x2); i < Math.min(x, x2) + (double)(width / 2.0F); ++i) {
         drawBorderRect(i, y, x2, y2, (new Color(((Double)setColor.r.getValue()).intValue(), ((Double)setColor.g.getValue()).intValue(), ((Double)setColor.b.getValue()).intValue())).getRGB(), 2.0D);
      }
